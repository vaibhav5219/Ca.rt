                ...
                <div className="container-fluid navigationbar">
                    ...
                    <div style={{display:"flex"}}>
...

                        {
                            state.Customer?.IsACustomer ?
                                <div>
                                    <a className="btn btn-outline-danger" onClick={ () => { history('/Customer/CustomerOrder') }} >Orders</a>  {/* href = '/Customer/CustomerOrder' */} 
                                </div>
                                :
                                ''
                        }
                        {
                            state.Shop?.ShopName ?
                                <div>
                                    <button className="btn btn-outline-danger">Your Orders</button>
                                </div>
                                :
                                ''
                        }
